...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.36\linewidth]{7.png}
    \label{fig:enter-label}
\end{figure}
...
\begin{definition}
    Let $(X,{\mathcal{O}}_{X})$ and $(Y,{\mathcal{O}}_{Y})$ be locally ringed spaces, then a \textbf{map of locally ringed spaces} is a map of ringed spaces s.t. for all $x\in X$, the map $f^{\#}_x:(\mathcal O_Y)_{f(x)}\to(\mathcal O_X)_x$ is a local map
\end{definition}
...
\begin{Proof}
    \begin{figure}[htp]
        \centering       \includegraphics[width=1\linewidth]{10.png}
    \end{figure}
    \begin{figure}[htp]
        \centering       \includegraphics[width=1\linewidth]{11.png}
    \end{figure}
    \begin{figure}[htp]
        \centering       \includegraphics[width=1\linewidth]{12.png}        
    \end{figure}
    \begin{figure}[htp]
        \centering       \includegraphics[width=1\linewidth]{13.png}        
    \end{figure}
    \begin{figure}[htp]
...
\begin{example}
    \begin{figure}[htp]
    \centering    \includegraphics[width=1\linewidth]{15.png}  
    \end{figure}
\end{example}
...
Caution! It will usually not be the case that $\mathbb{P}^{n}(R)=R^{n+1}-0\,/R^{\times}$ , for a general ring i ${\mathbf{}}R$ 
...
$$
\mathbb{P}^{n}(k)={{{\bigcup_{i o}^{n}U_{i}(k)}}}={{{\bigcup_{i=0}^{n}k^{n}=\mathbb{P}^{n}(k)}}}. 
$$
...
\begin{definition}
    ...
    Let $X$ be a scheme, a \textbf{line bundle} of $X$ is an $\mathcal O_X$-module that is locally isomorphic to $\mathcal O_X$

    More generally, $V$ is a \textbf{rank n vector bundle} if it is locally isomorphism to $\mathcal O_X^n=\bigoplus^n_{i=1}\mathcal O_X$
\end{definition}
...
\\
    ...
    If $Y\xrightarrow{t}X$, define $F(X)\xrightarrow{F(t)}F(Y)$

    $F(f)(\mathcal L,s_0,\cdots,s_n)=(f^\ast\mathcal L,f^\ast s_0,\cdots,f^\ast s_n)$

    $\Gamma(X,\mathcal L)\to\Gamma(X,f_\ast f^\ast\mathcal L)=\Gamma(Y,f^\ast\mathcal L)$

    $s_i\mapsto f^\ast s_i$

    global section : $s_i:\mathcal O_X\to \mathcal L$

    $f^\ast s_i\cong\mathcal O_Y: f^\ast\mathcal O_X\to f^\ast\mathcal L$
\end{definition}
...
\begin{definition}
    For $R$ any ring, define $\mathbb P_{R}^n=\mathbb P_{\mathbb Z}^n\times_{Spec\,\mathbb Z}Spec\,R$
\end{definition}
...
$$
The Yoneda lemma now tells us that $f^{*}{\cal M}\cong \widetilde{M\otimes_{A}B}$
...
\end{proposition}
\begin{Proof}
    If $W|U\cong \mathcal O_X^n|_U$, then :
\begin{align*}
\label{sup}
...
\mathbb V({W})(Y)
=O_{Y}(Y)^n
={\mathrm{Hom}}_{R i n g}(\mathbb{Z}[T_1,\cdots,T_n],O_{Y}(Y))\cong{\mathrm{Hom}}_{\operatorname{Sch}}(Y,\mathbb{A}^{n})\cong{\mathrm{Hom}}_{\operatorname{Sch}/X}(Y,\mathbb{A}^{n}\times X)
$$
...
\begin{definition}
    ...
    \;and\; 
    (S \xrightarrow {g}Y)\in P \Rightarrow
    (X\times_Y S\to S)\in P
    $$
