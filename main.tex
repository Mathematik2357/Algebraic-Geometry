...
An $R$-valued point of $\mathbb P^n$ is the data of a line bundle together with $n+1$ section (subject to a vanishing locus condition). If $y_0, y_1,...,y_n$ denote the global sections $R$-linear combinations of the $y_i$ make sense as global sections of this line bundle and in particular it makes sense to impose the condition that a specific $R$-linear combination vanishes.
